Shader "URP/NormalMap0"
{
...

    {
        ...
        struct v2f
        {
            ...
            float3 viewDirTan:TEXCOORD1;
            float3 lightDirTan:TEXCOORD2;
        ...
        {NAME"MainPass"
            ...
            v2f vert1(a2v i)
            {
                ...
                float3x3 trans = float3x3(i.tangent,tangent2,i.normalOS);
            ...
            real4 frag1(v2f i):SV_TARGET
            {
                ...
                real4 texcolor=(dot(normal,i.lightDirTan)*0.5+0.5)*SAMPLE_TEXTURE2D(_MainTex,sampler_MainTex,i.texcoord)*_BaseColor/PI;
                return texcolor;
